...
const HeroSection = () => {
  ...
  return (
    <section 
      id="home" 
      className="relative min-h-screen flex items-center bg-gradient-hero overflow-hidden pt-16"
    >
      <div className="absolute inset-0 bg-gradient-to-r from-deep-blue/90 to-electric-green/80" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-left">
            ...
            <p className="text-xl text-white/80 mb-8 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
              Yapay zeka, blockchain ve %100 yenilenebilir enerji kaynaklarıyla desteklenmiş 
