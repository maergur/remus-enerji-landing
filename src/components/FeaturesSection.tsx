...
const FeatureCard: React.FC<FeatureCardProps> = ({ title, description, icon, delay }) => (
  <div 
    className="feature-card animate-fade-in-up backdrop-blur-lg bg-white/10 border border-white/20" 
    ...
    <section id="features" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="section-title text-center">
          Neden <span className="bg-gradient-to-r from-electric-green to-deep-blue bg-clip-text text-transparent">Remus Energy</span>?
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          ...
          <FeatureCard
            title="Yeşil Blockchain"
            description="Şeffaf, güvenli enerji ticareti ve blockchain teknolojisi ile en uygun elektrik fiyatlarını tam hesap verebilirlik ile garanti eder."
            icon={<ShieldCheck />}
            delay="0.4s"
          />
        ...
        <div className="mt-16 bg-gradient-to-r from-deep-blue to-electric-green rounded-xl p-8 text-white backdrop-blur-lg">
              ...
              <div className="relative">
                ...
                <div className="bg-white/20 backdrop-blur-sm p-6 rounded-xl relative">
                  <div className="bg-white/10 rounded-lg p-4 mb-3">
                    ...
                    <h4 className="text-3xl font-bold">₺650</h4>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4 mb-3">
                    <p className="font-medium">Azaltılan CO₂ Emisyonu</p>
                    <h4 className="text-3xl font-bold">1.2 ton</h4>
                  </div>
